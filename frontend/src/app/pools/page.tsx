...
export default function PoolsEntry() {
  ...
  // Live compute required risk amount for entered USDC to target ~50/50 at current pool price
  ...
  const ensureApproval = async (token: `0x${string}`, spender: `0x${string}`, amount: bigint) => {
    try {
      ...
      // Skip reading owner from wagmi; rely on unlimited approval
